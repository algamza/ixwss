...
IXWebSocketServer::IXWebSocketServer(const char *path)
    : m_server_private(nullptr)
{
    m_server_private = new IXWebSocketServerPrivate(path);
}

IXWebSocketServer::~IXWebSocketServer()
{
    if ( m_server_private ) delete m_server_private;
}
