/**
 * @file IXWebSocketClientData.cpp
 ...
 *-------------------------------------------------------------------------------*/
IXWebSocketClientData::IXWebSocketClientData(unsigned char *data, int len)
...
IXWebSocketClientData::~IXWebSocketClientData()
{
    if( m_data ) delete []m_data;
}

const unsigned char *IXWebSocketClientData::getData() const
{ 
    return m_data; 
}

const int IXWebSocketClientData::getDataLength() const
{ 
